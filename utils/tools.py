...
class EarlyStopping:
    def __init__(self, patience=7, verbose=False, delta=0, urt=False, slow_learner=False):
    ...
    def save_checkpoint(self, val_loss, model, path):
        ...
        if self.urt:
            torch.save(model.state_dict(), path + '/' + 'checkpoint_urt.pth')
        elif self.slow_learner:
