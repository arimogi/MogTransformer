...
class Exp_FRNet_Detection(Exp_Basic):
    def __init__(self, args):
        super(Exp_FRNet_Detection, self).__init__(args)
...
#        txt_fname = "result_anomaly_detection-" + dt_string + ".txt"
...
#        csv_fname = "result_anomaly_detection-" + dt_string + ".csv"
#        f_csv = open(csv_fname, "a")
